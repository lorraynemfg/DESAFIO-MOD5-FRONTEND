...
import iconeEmDia from "../../assets/icone-em-dia.svg";
import "./style.css";
...
function TabelaEmDia() {
  return (
    <>
      <div className="container-tabelas-clientes">
        <div className="titulo-tabela-em-dia">
          <div className="imagem-titulo">
            <img src={iconeEmDia} alt="icone-inadimplente" />
        ...
        <div className="ancora-tabela-em-dia">
          <span>Ver todos</span>
        </div>
      </div>
    </>
